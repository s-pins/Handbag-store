...
urlpatterns = [
    ...
    path('stk-callback/', views.stk_callback, name='stk_callback'), # Added for M-Pesa callback
    ...
    path('download-invoice/<int:order_id>/', views.download_invoice, name='download_invoice'), # Added for downloading PDF invoice
    path('track-order/<int:order_id>/', views.order_tracking_view, name='order_tracking'), # Added for order tracking page
]